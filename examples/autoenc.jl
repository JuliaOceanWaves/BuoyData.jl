...
begin
	avail_pw = NDBC.available_omnidirectional(buoy)
	years = avail_pw.year
...
# ╔═╡ 79ec316f-3b6f-463d-8168-7f129343804c
size(alldata)

# ╔═╡ 74aae944-6113-4fae-85bf-834ba24f148b
begin
	f = alldata.axes[2].val
	d10 = alldata[10,:]
	d100 = alldata[100,:]
	d1000 = alldata[1000,:]
	d10000 = alldata[10000,:]
end

# ╔═╡ abd0f93f-b47f-4085-b98d-02caf2254123
begin
	plot(f, d10)
	plot!(f, d100)
	plot!(f, d1000)
...
# ╔═╡ 8e84f9e4-6b4b-44ea-8289-57bee03efa07
e10 = integrate(f, d10)

# ╔═╡ 82126148-3d59-44c7-96c5-c44081181894
e100 = integrate(f, d100)

# ╔═╡ 4b4dc840-99dc-4de1-87c6-676fd1a8180f
e1000 = integrate(f, d1000)

# ╔═╡ 957fbaf6-c7fa-4c97-a266-5a28c2851c07
e10000 = integrate(f, d10000)

# ╔═╡ 5c570d72-77b9-4cda-9cb2-333e3b1a519b
begin
	dn10 = d10 / e10
	dn100 = d100 / e100
	dn1000 = d1000 / e1000
	dn10000 = d10000 / e10000
end;

# ╔═╡ aae9c1a2-7493-40e2-b809-a2348dfb4cf8
begin
	plot(f, dn10)
	plot!(f, dn100)
	plot!(f, dn1000)
...
# ╔═╡ be333df9-21d1-4e3a-8090-5cc258ed7a28
integrate(f, dn10000)
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "dd2d5c262d5618387254e655618cb2febe6dcafe"
